...
import { createProduct, getAllProductsWithCategory, getProductsByCategory, initDb } from '@/lib/db';
...
export async function GET(req: NextRequest) {
  ...
  if (categoryId) {
    return NextResponse.json(getProductsByCategory(Number(categoryId)));
  }
